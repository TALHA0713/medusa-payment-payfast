...
export interface PayFastOptions {
  ...
  /** these settings are legacy considering that in future payfast may delink payment and capture */
  /**
...
export interface PayFastEvent {
  type: PaymentStatusCodeValues;
  id: string;
  data: {
    object: PayFastS2SResponse | PaymentProcessorError;
  };
}

export interface PayFastS2SResponse {
  success: boolean;
  code: PaymentStatusCodeValues;
  message: string;
  data: PayFastS2SResponseData;
}

export interface PayFastS2SResponseData {
  merchantId: string;
  merchantTransactionId: string;
  transactionId: string;
  amount: number;
  state: string;
  responseCode: string;
  paymentInstrument: PayFasteS2SResponsePaymentInstrument;
}

export type PayFasteS2SResponsePaymentInstrument =
    PayFastS2SResponsePaymentInstrumentUpi &
    PayFastS2SResponsePaymentInstrumentCard &
    PayFastS2SResponsePaymentInstrumentNetBanking;

export interface PayFastS2SResponsePaymentInstrumentUpi {
  type: string;
  utr?: string;
}

export interface PayFastS2SResponsePaymentInstrumentCard {
  type: string;
  cardType?: string;
  pgTransactionId?: string;
  bankTransactionId?: string;
...
export interface PayFastS2SResponsePaymentInstrumentNetBanking {
  type: string;
  pgTransactionId?: string;
  pgServiceTransactionId?: string;
  bankTransactionId?: string;
